		...
		>
			...
			<div className='carousel-inner'>
				...
				<div className='carousel-item'>
					<img src={escola} className='d-block w-100' alt='Alunos' />
				</div>
				<div className='carousel-item'>
					<img src={escola} className='d-block w-100' alt='Biblioteca' />
				</div>
				<div className='carousel-item'>
					<img src={escola} className='d-block w-100' alt='Laboratório' />
				</div>
			</div>
